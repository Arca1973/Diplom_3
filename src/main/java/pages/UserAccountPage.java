...
public class UserAccountPage {
    ...
    private final By registrationLink = By.xpath("//a[contains(@class, 'Auth_link_1f0l') and contains(text(), 'Зарегистрироваться')]"); //ссылка «Зарегистрироваться» в личном кабинете
