...
public class BaseTest {
    ...
    protected final String USER_ACCOUNT_PAGE_URL = "https://stellarburgers.nomoreparties.site/login";
    ...
    protected final String BIURGER_CONSTRUCTOR_PAGE_URL = "https://stellarburgers.nomoreparties.site/login";
